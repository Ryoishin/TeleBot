...
from ryoishin.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@ryoishin.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@ryoishin.on(admin_cmd(pattern="snips (.*)"))
...
@ryoishin.on(admin_cmd(pattern="snipl"))
...
@ryoishin.on(admin_cmd(pattern=r"snipd (\S+)"))
