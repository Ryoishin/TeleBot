...
@ryoishin.on(sudo_cmd(pattern="warn1", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@ryoishin.on(admin_cmd(pattern="warn2"))
@ryoishin.on(sudo_cmd(pattern="warn2", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@ryoishin.on(admin_cmd(pattern="warn3"))
@ryoishin.on(admin_cmd(pattern="warn3", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mentions = (
...
@ryoishin.on(admin_cmd(pattern="warn0"))
@ryoishin.on(admin_cmd(pattern="warn0", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@ryoishin.on(admin_cmd(pattern="ocb"))
@ryoishin.on(sudo_cmd(pattern="ocb", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@ryoishin.on(admin_cmd(pattern="fw"))
async def _(event):
    if event.fwd_from:
        return
