...
@ryoishin.on(admin_cmd(pattern="sthink (.*)"))
...
@ryoishin.on(admin_cmd(pattern="sdick (.*)"))
...
@ryoishin.on(admin_cmd(pattern="sfrog (.*)"))
...
@ryoishin.on(admin_cmd(pattern="sputin (.*)"))
...
@ryoishin.on(admin_cmd(pattern="sdead (.*)"))
...
@ryoishin.on(admin_cmd(pattern="strump (.*)"))
...
@ryoishin.on(admin_cmd(pattern="schina (.*)"))
...
@ryoishin.on(admin_cmd(pattern=r"spika"))
async def kakashi(pikachu):
    await pikachu.edit(F)


@ryoishin.on(admin_cmd(pattern=r"sshit"))
async def kakashi(shit):
    await shit.edit(G)


@ryoishin.on(admin_cmd(pattern=r"sxx"))
async def kakashi(saxy):
    await saxy.edit(H)


@ryoishin.on(admin_cmd(pattern=r"sporn"))
