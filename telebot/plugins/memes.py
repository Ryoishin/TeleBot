...
from ryoishin.utils import admin_cmd, register
...
@ryoishin.on(admin_cmd(outgoing=True, pattern=r"(\w+)say (.*)"))
...
@ryoishin.on(admin_cmd(outgoing=True, pattern=":/"))
async def kek(keks):
...
@ryoishin.on(admin_cmd(outgoing=True, pattern=r"coinflip (.*)"))
async def _(event):
...
@ryoishin.on(admin_cmd(pattern="slap(?: |$)(.*)", outgoing=True))
async def who(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="decide"))
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        if event.fwd_from:
            return
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="cry"))
async def cry(e):
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="insult"))
async def insult(e):
    """ I make you cry !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="cp(?: |$)(.*)"))
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="vapor(?: |$)(.*)"))
async def vapor(vpr):
    """ Vaporize everything! """
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="repo"))
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="str(?: |$)(.*)"))
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="zal(?: |$)(.*)"))
async def zal(zgfy):
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="hi"))
async def hoi(hello):
    """ Greet everyone! """
...
@ryoishin.on(admin_cmd(pattern=r"hi2"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit("🌺✨✨🌺✨🌺🌺🌺\n🌺✨✨🌺✨✨🌺✨\n🌺🌺🌺🌺✨✨🌺✨\n🌺✨✨🌺✨✨🌺✨\n🌺✨✨🌺✨🌺🌺🌺\n☁☁☁☁☁☁☁☁")
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="kill"))
