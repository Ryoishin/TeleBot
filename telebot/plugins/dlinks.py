...
# Re-written by @its_TeamRyoishin for Ryoishin
...
@ryoishin.on(admin_cmd(outgoing=True, pattern=r"direct(?: |$)([\s\S]*)"))
@ryoishin.on(sudo_cmd(allow_sudo=True, pattern=r"direct(?: |$)([\s\S]*)"))
