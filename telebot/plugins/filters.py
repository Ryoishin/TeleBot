...
@ryoishin.on(admin_cmd(pattern="savefilter (.*)"))
@ryoishin.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@ryoishin.on(admin_cmd(pattern="listfilters"))
@ryoishin.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@ryoishin.on(admin_cmd(pattern="clearfilter (.*)"))
@ryoishin.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@ryoishin.on(admin_cmd(pattern="clearallfilters"))
@ryoishin.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
