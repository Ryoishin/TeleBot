# @RyoishinSupport Keep Credits If You Are Goanna Kang This Lol
...
@ryoishin.on(admin_cmd(pattern="avengersdp ?(.*)"))
async def main(event):

    await event.edit(
        "**Starting Avengers Profile Pic...\n\nDone !!! Check Your DP in 5 seconds. By [Ryoishin](https://github.com/TeamRyoishin/Ryoishin)**"
    )
