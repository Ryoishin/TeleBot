...
@ryoishin.on(admin_cmd(outgoing=True, pattern="purge"))
@ryoishin.on(sudo_cmd(allow_sudo=True, pattern="purge"))
@errors_handler
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="purgeme"))
@errors_handler
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="del"))
@errors_handler
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="edit"))
@errors_handler
...
@ryoishin.on(admin_cmd(outgoing=True, pattern="sd"))
@errors_handler
