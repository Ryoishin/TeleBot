...
@ryoishin.on(admin_cmd(pattern="repcf", outgoing=True))
@ryoishin.on(sudo_cmd(pattern="repcf", allow_sudo=True))
...
@ryoishin.on(admin_cmd(pattern="addcf", outgoing=True))
@ryoishin.on(sudo_cmd(pattern="addcf", allow_sudo=True))
...
@ryoishin.on(admin_cmd(pattern="remcf", outgoing=True))
@ryoishin.on(sudo_cmd(pattern="remcf", allow_sudo=True))
